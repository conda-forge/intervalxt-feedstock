...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/intervalxt-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/intervalxt-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libintervalxt pyintervalxt
# for installing globally
pixi global install libintervalxt pyintervalxt
```
...
It is possible to list all of the versions of `libintervalxt` available on your platform:
...
```
pixi search libintervalxt --channel conda-forge
```
